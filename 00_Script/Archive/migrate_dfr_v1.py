...
def clean_identifier_list(identifier, remove_fields=None):
    """
    Removes 'type' and 'idScheme' keys from each item in a list or dict.
    """
...
def migrate_general_v_050_to_v_060(component):
    ...
    for service in services:
        ...
        for param in params:
            if 'storage' in param:
                #print('before update:', param['storage']["url"])
                param['storage']["url"] = "http://localhost:3334/api/1.0.0/documents"

                #print('after update:', param['storage']["url"])
                #print('inside')
...
def migrate_dfr_v050_to_v060(dfr_component):
    ...
    # Replace the version part (v/0.5.0 or v/0.6.0) with the new version
    # new_version = "0.6.0"
    # new_url = re.sub(r'v/\d+\.\d+\.\d+', f'v/{new_version}', schema["url"])
    # schema["url"] = new_url
...
#file_path = r"C:\Users\karinaliauw\Downloads\MSPYX-728 - Upgrade\upgrade_test\test4input.json"
...
migrated_dfr_path = r"C:\Users\karinaliauw\Downloads\MSPYX-728 - Upgrade\python\DFR_migrated_v060_test_v4.json"
#migrated_dfr_path = r"C:\Users\karinaliauw\Downloads\MSPYX-728 - Upgrade\upgrade_test\test4input-python4.json"
