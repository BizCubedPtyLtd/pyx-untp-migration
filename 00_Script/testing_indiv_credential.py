...
if __name__ == "__main__":
    ...
    testing_folder = 'DPP'
    version = '0.6.0'
    output_file_name = f"transformed-{testing_folder}-{file_name}-v0.6.0.json"
...
#     testing_folder = 'DCC'
#     output_file_name = f"sample-{testing_folder}-test-output.json"
#     input_path = current_dir.parent / input_folder_name / brand_name / testing_folder / file_name
#     output_path = current_dir.parent / input_folder_name / brand_name / testing_folder / output_file_name
#     ###########################################################
...
#     # Example usage: read a single credential from a file
#     with open(input_path) as f:
#         credential = json.load(f)
#     transformed = transform_components(credential)
#     with open(output_path, "w") as f:
